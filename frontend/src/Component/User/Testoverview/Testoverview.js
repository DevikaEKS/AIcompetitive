...
function Testoverview() {
  ...
  return (
    <div className="container-fluid testoverviewpage">
      ...
      <div className="sidebar-menu d-block d-sm-none">
        <button className="sidebar-toggle" onClick={toggleSidebar}>
          Menu
        </button>
        {isSidebarOpen && (
          <div className="sidebar-content">
            <Link to="#sbi-clerk" onClick={() => setIsSidebarOpen(false)}>SBI Clerk</Link>
            <Link to="#sbi-cbo" onClick={() => setIsSidebarOpen(false)}>SBI CBO</Link>
            <Link to="#ibps-po" onClick={() => setIsSidebarOpen(false)}>IBPS PO</Link>
          </div>
        )}
      </div>
      ...
      <div className="row">
        ...
        <div className="col-lg-8 contentpart">
          ...
          <div className="row sampletestarea p-2 my-4 mx-2">
            ...
            <div className="col-sm-12 col-md-6 d-flex justify-content-center align-items-center">
              <div className="text-center">
                <h4>Ready to Test Your Skills? Take a Free Sample Test!</h4>
                <Link to={"/terms"}>
                  <button className="Taketestbtn mt-3 rounded-5 p-3">Take Test</button>
                </Link>
              </div>
            </div>
          </div>
          ...
          <table className="tablearea w-100 rounded-5">
            <thead>
              <tr><th colSpan={2}>SBI Clerk 2024 Important Dates</th></tr>
              <tr className="bg-light">
                <th>Events</th>
                <th>SBI Clerk 2024 Dates</th>
              </tr>
